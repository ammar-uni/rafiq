...
const prayerSources=await Promise.all(['prayer-config','prayer-times','occasion-times','prayer-app'].map(async name=>strip(await readFile(new URL('../src/'+name+'.mjs',import.meta.url),'utf8'))));
