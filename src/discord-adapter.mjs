...
export function statusPayload(interaction, store) {
  ...
  return noticePayload('رفيق في هذا السيرفر', [
    ...
    'التفعيل اختياري. المجالس المشتركة من ٥ دقائق؛ مهلة خروج دقيقة. البداية: حتى ٣ تذكيرات بإشعار خلال ٢٤ ساعة، بفاصل ساعتين. يمكن تغيير التكرار واختيار بلا تنبيه.',
