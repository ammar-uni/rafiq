...
import { DHIKR_CARDS, GOOD_DEEDS, OCCASION_CARDS, HADITH_BOOKS } from './content.mjs';
...
export function assertReviewedContent(cards = [...DHIKR_CARDS, ...GOOD_DEEDS, ...Object.values(OCCASION_CARDS)], review = JSON.parse(readFileSync(new URL('./content-review.json', import.meta.url), 'utf8'))) {
